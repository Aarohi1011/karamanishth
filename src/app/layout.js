...
// Define your default URL (replace with your actual URL)
...
export const metadata = {
  ...
  icons: {
    icon: [
      ...
      // Reuse the 196x196 icon for Android as it's the closest match
  ...
  // Apple-specific configurations (unchanged)
  appleWebApp: {
    capable: true,
