      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-3xl">
        ...
        <div className="text-center">
          <div className="flex justify-center">
            <div className="w-16 h-16 bg-[#7AE2CF] rounded-xl flex items-center justify-center shadow-lg">
              <svg className="w-10 h-10 text-[#06202B]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
